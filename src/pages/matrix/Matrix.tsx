...
const Matrix = () => {
  ...
  return (
    <>
      ...
      {pickedRegisters && (pickedRegisters as any).length > 0 && (
        <div className="card-container-title">Attached registers</div>
      )}

      <div className="register__card-container">
        {pickedRegisters &&
          (pickedRegisters as any).map((risk: any) => (
            <RegisterCard risk={risk} />
          ))}
      </div>
